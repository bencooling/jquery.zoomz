...
define("assets/vendor/almond/almond", function(){});
...
require.config({
   ...
   , 'modernizr' : 'assets/vendor/modernizr/modernizr'
   , 'slick'     : 'assets/vendor/slick.js/slick/slick'
   , 'zoomz'     : 'dist/jquery.zoomz'
  },
  shim: {
...
define('assets/js/main',['jquery', 'slick', 'zoomz'], function($){
...
// var parralax = _.debounce(, 500);
  ...
  $(window).scroll(function(e){
    var pos  = $(window).scrollTop()
      , value = "translate3d(0px, -"+(pos/3)+"px, 0px)"
      ;
    $header.css({"-webkit-transform":value, "-moz-transform":value, "-ms-transform":value, "transform":value });
  });
// }
});
